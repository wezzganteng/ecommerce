              ...
              <li v-for="cart in getCart" :key="cart.cart_id" class="flex flex-col space-y-3 py-6 text-left sm:flex-row sm:space-x-5 sm:space-y-0">
                ...
                <div class="relative flex flex-1 flex-col justify-between">
                  ...
                  <div class="absolute top-0 right-0 flex sm:bottom-0 sm:top-auto">
                    <button @click="removeItem(cart.cart_id)" type="button" class="flex rounded p-2 text-center text-gray-500 transition-all duration-200 ease-in-out focus:shadow hover:text-gray-900">
