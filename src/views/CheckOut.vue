<template>
  <br><br>
  <div class="flex flex-col items-center border-b bg-white py-4 sm:flex-row sm:px-10 lg:px-20 xl:px-32 pt-20">
  ...
  <div class="px-4 pt-8">
    ...
    <p class="mt-8 text-lg font-medium">Delivery Option</p>
            <form class="grid grid-cols-2 gap-2">
                <div class="relative">
                    <input class="peer hidden" id="radio_3" type="radio" value="standard" v-model="deliveryType" />
                    <span
                ...
                <div class="relative">
                    <input class="peer hidden" id="radio_4" type="radio" value="express" v-model="deliveryType" />
                    <span
                        class="peer-checked:border-gray-700 absolute right-4 top-1/2 box-content block h-3 w-3 -translate-y-1/2 rounded-full border-8 border-gray-300 bg-white"></span>
                    <label
                        class="peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4"
