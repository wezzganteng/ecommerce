<template>
  ...
  <div class="relative bg-emerald-50 text-gray-900">
    <div class="relative py-12 sm:py-16 lg:py-20 lg:pb-36">
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="mx-auto ml-20 grid max-w-lg grid-cols-1 gap-y-12 lg:max-w-full lg:grid-cols-2 lg:items-center lg:gap-x-8">
          <div>
            <div class="text-center lg:text-left">
              <h1 class="max-w-md text-4xl font-bold leading-snug sm:text-5xl sm:leading-snug">
                Shop affordably <br class="block sm:hidden" />
                 <br class="hidden sm:block" />
                only <span class="rounded-xl bg-emerald-400 border-green-600 px-2 pb-2 text-white">SEGAR</span>
              </h1>
              <p class="mt-2 text-lg text-gray-600 sm:mt-8"></p>
              <div class="mt-8 flex flex-col items-center justify-center sm:flex-row sm:space-x-4 lg:justify-start">
                <button class="relative mt-4 rounded-lg border-2 border-green-600 bg-emerald-400 px-6 py-2 font-medium text-white transition hover:translate-y-1">
                  <div class="-scale-x-100 absolute left-0 -bottom-10 hidden h-10 w-10 -rotate-12 text-emerald-600 md:inline-flex">
                ...
                <button class="mt-4 flex items-center rounded-lg border-2 border-green-600 px-6 py-2 font-medium text-green-600 transition hover:translate-y-1 hover:bg-white">
          ...
          <div class="basis-1/2 pt-10 mr-7">
      <img src="../assets/img/store-removebg-preview.png"  alt="">
      </div>
        </div> <br><br> 
        </div>
      </div>
