      ...
      <div class="relative mx-auto overflow-hidden px-4 py-16 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8 lg:py-20">
        <div class="flex flex-col items-center justify-between xl:flex-row">
          <div class="mb-12 w-full max-w-xl xl:mb-0 xl:w-7/12 xl:pr-16">
            <h2 class="mb-6 max-w-lg font-sans text-3xl font-bold tracking-tight text-white sm:text-7xl sm:leading-none">Please create your account</h2>
            <p class="mb-4 max-w-xl text-base text-gray-200 md:text-lg">"Start Shopping Today! Register now and dive into a world of endless e-commerce opportunities."</p>
          ...
          <div class="w-full max-w-xl xl:w-5/12 xl:px-8 pt-20">
            <div class="overflow-hidden rounded-xl border-t-4 border-emerald-600 bg-white p-7 shadow-2xl shadow-emerald-300 sm:p-10">
              <h3 class="mb-4 text-xl font-bold text-emerald-900 sm:mb-6 sm:text-center sm:text-2xl"> SIGN UP</h3>
              <form  @submit.prevent="performRegister">
                   <div class="mb-1 sm:mb-2">
                  <label for="email" class="mb-1 inline-block font-medium text-emerald-900 font-medium uppercase">name</label>
                  <input v-model="name" placeholder="Enter your email" required="" type="text" class="mb-2 h-12 w-full flex-grow appearance-none rounded border border-gray-300 bg-white px-4 shadow-sm ring-emerald-200 transition duration-200 focus:border-emerald-400 focus:outline-none focus:ring" id="firstName" name="firstName" />
                </div>
                <div class="mb-1 sm:mb-2">
                ...
                <div class="mb-1 sm:mb-2">
                  <label for="password" class="mb-1 inline-block font-medium text-emerald-900 font-medium uppercase">confirm password</label>
                  <input v-model="confirm_password" placeholder="********" required="" type="password" class="mb-2 h-12 w-full flex-grow appearance-none rounded border border-gray-300 bg-white px-4 shadow-sm ring-emerald-200 transition duration-200 focus:border-emerald-400 focus:outline-none focus:ring" id="lastName" name="lastName" />
                </div>

                <div class="mb-1 sm:mb-2">
                  <label for="password" class="mb-1 inline-block font-medium text-emerald-900 font-medium uppercase">phone</label>
                  <input v-model="phone" placeholder="08xxxxxxx" required="" type="pnumber" class="mb-2 h-12 w-full flex-grow appearance-none rounded border border-gray-300 bg-white px-4 shadow-sm ring-emerald-200 transition duration-200 focus:border-emerald-400 focus:outline-none focus:ring" id="lastName" name="lastName" />
                </div>
                
                <div class="mt-4 mb-2 sm:mb-4">
                  <button type="submit" class="inline-flex h-12 w-full items-center justify-center rounded-xl bg-emerald-600 px-6 font-medium tracking-wide text-white shadow-md ring-emerald-200 transition duration-200 hover:bg-emerald-700 focus:outline-none focus:ring">Create account</button>
                </div>
